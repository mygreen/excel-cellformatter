...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("Excel-CellFormatter 0.2 ドキュメント");
        $("div.related:last  ul li:not(.right):first a").text("Excel-CellFormatter 0.2 ドキュメント");
    }
});